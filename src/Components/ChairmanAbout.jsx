        ...
        <div className="my-6">
            <section className="flex md:flex-row flex-col-reverse items-center justify-between p-16 rounded-lg md:space-x-8">
                <div className="md:w-1/2 text-center md:text-left mb-6 md:mb-0 space-y-4">
                    ...
                    <h3 className="text-green font-bold text-2xl anim-left">Chairman <span className="text-green">SWIT</span></h3>
            ...
            <section className="flex md:flex-row flex-col-reverse items-center justify-between p-16 rounded-lg md:space-x-8">
                <div className="md:w-1/2 text-center md:text-left mb-6 md:mb-0 space-y-4">
                    ...
                    <h3 className="text-green font-bold text-2xl anim-left">Chairman Educational Board <span className="text-green">SWIT</span></h3>
                    <p className="text-[16px] anim-left md:text-lg anim-left">
                ...
                <div className="md:w-[50%] my-5 anim-zoom">
                    <img
                        src="/Afzal.jpg"
                        alt="Saylani Welfare"
                        className="sm:w-[45%] h-auto mx-auto w-[100%] hover:scale-105 transition duration-500 ease-in-out rounded-lg"
                    />
                </div>
            </section>
        </div>
