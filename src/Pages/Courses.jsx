            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <form action="#">
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-green-500" placeholder="Enter your full name" />
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2" for="email">Email</label>
                        <input type="email" id="email" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-green-500" placeholder="Enter your email" />
                    </div>
                    <div class="mb-4">
                        <label class="block text-gray-700 font-bold mb-2" for="campus">Preferred Campus</label>
                        <select id="campus" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-green-500">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="course" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-green-500" value={Course?.title} readonly />
                    </div>
